...
app_list = pd.read_csv(r'C:\Users\UTEC\Desktop\hci584\HCI584 - STEM games')

# display first few rows
app_list.head()

#define download logic to prevent the system from downloading all the games in one go. 
